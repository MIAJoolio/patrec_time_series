...
from patrec.feature_extraction.CoST.cost import CoST 
from patrec.feature_extraction.CoST.models.encoder import CoSTEncoder
from utils import take_per_row, split_with_nan, centerize_vary_length_series, torch_pad_nan

from patrec.feature_extraction.old_fe_classes import Base_extractor, FE_result


class TS2VecExtractor(Base_extractor):
...
class CoSTExtractor(Base_extractor):
