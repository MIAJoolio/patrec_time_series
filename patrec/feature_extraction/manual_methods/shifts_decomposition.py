...
class Peaks_break_detector(Base_decomposer):
    """
    ...
    def decompose(self, data: np.ndarray) -> Decomposition_result:
        ...
        return Decomposition_result(
            ...
            component_type=FE_component_type.SHIFT,
...
class ACF_break_detector(Base_decomposer):
    """
...
class Pelt_break_detector(Base_decomposer):
    """
...
class CUSUM_break_detector(Base_decomposer):
    """
...
class HMM_break_detector(Base_decomposer):
    """
