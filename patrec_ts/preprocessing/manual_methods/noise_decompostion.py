...
from patrec_ts.feature_extraction.fe_classes import BaseDecomposer, DecompositionResult, FEComponentType
from patrec_ts.generation import normal_noise, poisson_noise, uniform_noise, exponential_noise


class NoiseEvaluator(BaseDecomposer):
    """
    ...
    def decompose(self, noise_component: np.ndarray) -> DecompositionResult:
        ...
        return DecompositionResult(
            ...
            component_type=FEComponentType.NOISE,
...
class SyntheticNoiseGenerator:
    ...
    def evaluate_fit(self, target_noise: np.ndarray) -> dict[str, np.floating]:
        """
