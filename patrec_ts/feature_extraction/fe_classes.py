...
class DecompositionResult:
    ...
    Attributes:
        ...
        component_type: Type of the component (from FEComponentType)
    ...
    component_type: FEComponentType
    method_name: str
    params: dict[str, Any]
    stats: dict[str, Any]
    ...
    def optimize(
        ...
        def objective(trial: optuna.Trial) -> float:
            ...
            try:
                ...
                trend = result.component if isinstance(result, DecompositionResult) else result
...
class BaseDecomposer(ABC):
    ...
    def decompose(
        ...
        data: np.ndarray,
        **kwargs
    ) -> DecompositionResult | dict[FEComponentType, DecompositionResult]:
        """
        ...
        Returns:
            Either a single DecompositionResult or a dictionary mapping
            FEComponentType to DecompositionResult for multiple components
        """
        pass
...
#     def __init__(
#             self,
#             decomposers: list[BaseDecomposer],
#             feature_extractors: Optional[dict[FEComponentType, Base_fe_extractor]] = None
#     ):
#         """
...
#             components = (
#                 [decomp_result] if isinstance(decomp_result, DecompositionResult)
