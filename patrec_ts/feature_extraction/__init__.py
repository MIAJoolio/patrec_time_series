...
from patrec_ts.preprocessing.manual_methods.TS_feature_extractor import Feature_extraction_method, Feature_extractor_pipeline

from patrec_ts.preprocessing.manual_methods.trend_fe_algo import *
